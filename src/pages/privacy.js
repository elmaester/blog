...
const PrivacyPage = ({ data }) => (
  <>
    ...
    <Header />
    <main className="set-global-width privacy">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Oleg.Date Blog.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Oleg.Date Blog, accessible from{" "}
            <a
              href="https://blog.oleg.date"
              rel="external nofollow noreferrer noopener"
              target="_blank"
            >
              https://blog.oleg.date
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: blog.oleg.date@gmail.com</li>
      </ul>
    </main>
  </>
);
